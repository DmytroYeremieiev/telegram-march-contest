...
function render(_) {
  ...
  createXaxi(_.panViewChart.xAxiGroup, _.x, _.panViewChart);
...
function create(placement, config, data){
  ...
  chart._.panViewChart.linesSvg.append(chart._.panViewChart.xAxiGroup);
